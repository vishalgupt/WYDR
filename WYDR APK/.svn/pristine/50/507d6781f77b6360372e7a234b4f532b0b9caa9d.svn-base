 ...
 */
public class AllSellers extends AppCompatActivity implements SearchView.OnQueryTextListener, View.OnClickListener
{
    ...
    private boolean isLoading, isSelect = true;
    private View loadingFooter;
    private String user_cur_id, compid, netid, user_name, filterResult, filtertext = "", sort_order, sort_by, catfiltr_id = "";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tooltitle.setText(getString(R.string.all_sellers));
        alertDialog = new Dialog(AllSellers.this, R.style.mydialogstyle);
        ...
        loadingFooter = LayoutInflater.from(AllSellers.this).inflate(R.layout.pagination_loading, null);
        ...
        View view = View.inflate(AllSellers.this, R.layout.category_header, null);
...
//                                sellerList.addFooterView(loadingFooter);
        ...
        adapter = new AllSellersAdapter(context, users, AllSellers.this);
...
//                        sellerList.addFooterView(loadingFooter);
        ...
        sellerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                application.trackEvent("All Sellers", "onClick", "AllSellers");
                /*******************************ISTIAQUE***************************************/
                ...
                if (adapter != null)
                {
                    ...
                    profile.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (cd.isConnectingToInternet()) {
                                startActivity(new Intent(AllSellers.this, SellerProfile.class).putExtra("userid", user_cur_id).putExtra("username", user_name).putExtra("company_id", compid).putExtra("BackFlag", "AllSellers"));
                            } else {
                                new AlertDialogManager().showAlertDialog(AllSellers.this, getString(R.string.oops), getString(R.string.no_internet_conn));
                            }
                    ...
                    query.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (cd.isConnectingToInternet())
                            {
                                startActivity(new Intent(AllSellers.this, SellersQuery.class).putExtra("seller_id", user_cur_id).putExtra("username", user_name).putExtra("company_id", compid).putExtra("userid", netid).putExtra("user_id", user_cur_id).putExtra("BackFlag", "AllSellers" + "/1"));
                            }
                    ...
                    catalog.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (cd.isConnectingToInternet()) {
                                startActivity(new Intent(AllSellers.this, SellersCatalog.class).putExtra("username", user_name).putExtra("company_id", compid).putExtra("seller_id", user_cur_id).putExtra("userid", netid).putExtra("user_id", user_cur_id).putExtra("BackFlag", "AllSellers" + "/1"))
                                ;
                            } else {
                                new AlertDialogManager().showAlertDialog(AllSellers.this, getString(R.string.oops), getString(R.string.no_internet_conn));
                            }
    ...
    private void progressStuff() {
        ...
        cd = new ConnectionDetector(AllSellers.this);
        parser = new JSONParser();
        progress = new ProgressDialog(AllSellers.this);
        progress.setMessage(getString(R.string.loading));
        progress.setIndeterminate(false);
        progress.setCancelable(true);
        alertDialog2 = new AlertDialog.Builder(AllSellers.this);
    }

    public void onFilter(View v) {
        if (jsonArray != null)
            startActivityForResult(new Intent(AllSellers.this, LoacationFilterActivity.class).putExtra("filter", jsonArray.toString()).putExtra("request_code", FILTER_REQUEST), FILTER_REQUEST);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        notifCount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(AllSellers.this, CartActivity.class));
            }
        });
    ...
    public void onBackPressed() {
        if (listView.getVisibility() == View.VISIBLE) {
            ...
            startActivity(new Intent(AllSellers.this, Home.class));
            users.clear();
            adapter.notifyDataSetChanged();
            finish();
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.myCategory:
                ...
                if (cd.isConnectingToInternet()) {
                    new GetUserCategory().execute(helper.getDefaults("company_id", AllSellers.this));
                } else {
                    loadSubCategory();
                }
                break;
    ...
    private void loadCategory() {
        ...
        adapter2 = new RootAdapterExp(AllSellers.this, obj, grpLst, childLst, grpExpLst);
    ...
    private void loadSubCategory() {
        ...
        obj = new ObjectItems();
        MyDatabaseHelper dbHelper = new MyDatabaseHelper(AllSellers.this);
    ...
    private class GetUserCategory extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject json = parser.makeHttpRequest(AppUtil.URL + "3.0/vendors/" + args[0] + "/categories", "GET", params, AllSellers.this);
            try {
                if (json != null) {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if ((AllSellers.this != null) && !isFinishing()) {
                progress.dismiss();
                if (flag == 1) {
                    loadSubCategory();
                } else {
    ...
    protected void onResume() {
        ...
        Controller application = (Controller) getApplication();
        Tracker mTracker = application.getDefaultTracker();
        mTracker.setScreenName(getString(R.string.all_sellers));
    ...
    private void prepareRequest() {
        ...
        if (page_no != 0) {
            ...
            Call<SellerList> call = service.getSellers("v", page_no, "true", sort_order, sort_by,
                    catfiltr_id, "Y", loc, "", helper.getB64Auth(AllSellers.this), "application/json", "application/json");
                ...
                public void onResponse(Response response) {
                    ...
                    if (response.isSuccess()) {
                        ...
                        if (statusCode == 401) {
                            ...
                            final SessionManager sessionManager = new SessionManager(AllSellers.this);
                            ...
                            if (AllSellers.this != null && !AllSellers.this.isFinishing()) {
                                new AlertDialogManager().showAlertDialog(AllSellers.this,
