...
import wydr.sellers.gson.FavoriteQueryModal;
...
public class FavoriteQueryAdapter extends BaseAdapter implements Filterable {
    ...
    private ArrayList<FavoriteQueryModal> data, memberData;
    ...
    public FavoriteQueryAdapter(Activity a, ArrayList<FavoriteQueryModal> d) {
        activity = a;
        data = d;
        this.memberData = d;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final FavoriteQueryModal modal = data.get(position);
        ...
        if (modal.getCompanyId().equalsIgnoreCase(helper.getDefaults("user_id", activity).toString()) &&
...
//                Dialog dialog = new Dialog(activity);
                ...
                Log.i("QUERY-", modal.isFav() + "/" + modal.getTitle());
                if (modal.isFav().equalsIgnoreCase("query")) {
                ...
                view.findViewById(R.id.like_wrap).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (cd.isConnectingToInternet()) {
                            Log.e("---", modal.isFav() + "");
                            new LikeQuery(position, modal).execute();
                        } else {
...
//        cursor.close();
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                // values
                ArrayList<FavoriteQueryModal> filterlist = new ArrayList<>();

                if (memberData == null) {
                    memberData = new ArrayList<FavoriteQueryModal>();
                ...
                if (constraint != null && memberData != null && memberData.size() > 0) {
                    ...
                    for (int i = 0; i < memberData.size(); i++) {
                        ...
                        if (data.toLowerCase().contains(constraint.toString())) {
                            FavoriteQueryModal modal = new FavoriteQueryModal();
            ...
            protected void publishResults(CharSequence constraint,
                ...
                data = (ArrayList<FavoriteQueryModal>) results.values;
    ...
    private void getPrimary(final FavoriteQueryModal modal, final String queryText, final String imgUrl) {
                    ...
                    if (response.isSuccess()) {
                        ...
                        if (json != null && json.has("users")) {
                            try {
                                ...
                                cursor.moveToFirst();
                                Log.i("QueryAdpater", cursor.getCount() + " cursor.getCount()");
                                if (cursor.getCount() == 0) {
                                    Log.i("QueryAdpater", modal.getId() + " modal.getId()");
    ...
    private class LikeQuery extends AsyncTask<String, String, JSONObject> {
        ...
        public FavoriteQueryModal productModal;
        Boolean success = false;
        JSONObject table = new JSONObject();

        public LikeQuery(int pos, FavoriteQueryModal tag) {
            this.productModal = tag;
            this.pos = pos;
            Log.e("productModal", productModal.getTitle() + "-" + pos);
        }
        ...
        protected void onPostExecute(JSONObject json) {
            if (!activity.isFinishing()) {
                ...
                if (flag == 0) {
                    ...
                    if (success) {
                        data.remove(pos);
                        FavoriteQueryAdapter.this.notifyDataSetChanged();
                    }
                }
            }
        }
