...
/**
 * Created by surya on 25/11/15.
 */
public class QueryCategoryAdapter extends BaseExpandableListAdapter {
    ...
    public QueryCategoryAdapter(Context context, ObjectItems root, ExpandableListView.OnGroupClickListener grpLst,
    ...
    public long getChildId(int groupPosition, int childPosition) {
        //Log.i("QUERYADAP","childPosition" + childPosition);
