...
import wydr.sellers.modal.NewBroadcast;
                    ...
                    if (cursor.getCount() > 0) {
                        ...
                        if (name.getText().toString() != null && !name.getText().toString().equalsIgnoreCase("")) {
                            if (memberList.size() > 1) {
                                ...
                                /**************************ISTIAQUE********************************/
                                ArrayList<NewBroadcast> list = new ArrayList<>();
                                /******************************************************************/
                                for (int i = 0; i < memberList.size(); i++) {
                                    ...
                                    /*****************************ISTIAQUE*****************************************************/
                                    NewBroadcast newBroadcast = new NewBroadcast();
                                    newBroadcast.setBroadcastId(bId);
                                    newBroadcast.setBroadcastName(broadcastName);
                                    newBroadcast.setCreationDate(format.format(Calendar.getInstance().getTime()));
                                    newBroadcast.setMemberName(member.getName());
                                    newBroadcast.setMemberJid(member.getJid());
                                    newBroadcast.setKeyType("broadcast");
                                    list.add(newBroadcast);
                                    //sendBroadcastGroupDetails(newBroadcast);
                                    /*************************************************************************************/
                                }
