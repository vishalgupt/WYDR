...
public class SharedByMe extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.i("SharedByme ", "product_id " + product_id);
            }
        });
        NetAsync();
        return view;
    ...
    private void prepareRequest() {
        ...
        if (pageNo != 0) {
            ...
            Call<SharedHolder> call = service.SharedByME("false", pageNo, current_user_id, "by_me", "product", helper.getB64Auth(getActivity()), "application/json", "application/json");
