...
public class Help extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://staging.wydr.in/help.php");

        pd = ProgressDialog.show(Help.this, "Please Wait", "Page is Loading...", true);
    ...
    protected void onResume() {
        ...
        mTracker.send(new HitBuilders.TimingBuilder().setCategory("My help - Submit").setValue(System.currentTimeMillis() - startTime).build());
    }
}
