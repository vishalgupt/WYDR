...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        synchronized (sSyncAdapterLock) {
            Log.i(TAG, "sSyncAdapterLock ");
            if (sSyncAdapter == null) {
                Log.i(TAG, "Going in SyncAdapter");

                /*Code By Auriga and Commented out by Istiaque due to SessionManager issue*/
                /*sSyncAdapter = new SyncAdapter(getApplicationContext(), true);*/

                sSyncAdapter = new SyncAdapter(SyncService.this , true);// By Istiaque
