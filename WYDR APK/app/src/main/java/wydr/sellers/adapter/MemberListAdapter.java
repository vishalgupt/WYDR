...
public class MemberListAdapter extends BaseAdapter implements Filterable {
    ...
    public MemberListAdapter(Activity a, ArrayList<Member> d) {
        activity = a;
        data = d;
        memberData = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if (convertView == null)
            vi = inflater.inflate(R.layout.member_list_layout, null);

        TextView name = (TextView) vi.findViewById(R.id.textViewMemberListName);
        //   ImageView close = (ImageView) vi.findViewById(R.id.imageViewDeleteMember);
        ImageView thumb = (ImageView) vi.findViewById(R.id.imageViewMemberList);
