    ...
    public static void addEmojis(Context context, Spannable text, int emojiSize, int index, int length) {
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon == 0) {
                ...
                //Log.i("unicode ", unicode + " " + (0x1f436==unicode));
                ...
                switch (unicode) {
                    ...
                    case 0x1f43b:
                    case 0x1f437:
                        size =(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 45, context.getResources().getDisplayMetrics())  ;
                        break;
                    default:
                        size =(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, context.getResources().getDisplayMetrics())  ;
                        break;
                }
          ...
          //  Log.i("final size " ,""+ size);
            if (icon > 0) {
                text.setSpan(new EmojiconSpan(context, icon, size), i, i + skip, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    }
}
