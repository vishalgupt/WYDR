...
import wydr.sellers.emojicon.emoji.Nature;
import wydr.sellers.emojicon.emoji.Objects;
import wydr.sellers.emojicon.emoji.People;
import wydr.sellers.emojicon.emoji.Places;
import wydr.sellers.emojicon.emoji.Symbols;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
    ...
    private View createCustomView() {
        ...
        mEmojisAdapter = new EmojisPagerAdapter(
                Arrays.asList(
                        new EmojiconRecentsGridView(mContext, null, null, this,true),
                        new EmojiconGridView(mContext, Nature.DATA, recents, this,true),
        ...
        mEmojiTabs[2] = view.findViewById(R.id.emojis_tab_1_people);
