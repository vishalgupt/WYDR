...
public class DonutProgress extends View {
    ...
    protected void initPainters() {
        ...
        finishedPaint.setColor(Color.rgb(74, 161, 218));
        finishedPaint.setStyle(Paint.Style.FILL);
        finishedPaint.setAntiAlias(true);
        finishedPaint.setStrokeWidth(finishedStrokeWidth);

        unfinishedPaint = new Paint();
        unfinishedPaint.setColor(Color.rgb(125, 168, 206));
        unfinishedPaint.setStyle(Paint.Style.FILL);
    ...
    public void setProgress(int progress) {
        ...
        this.SHOWprogress = this.SHOWprogress - 1;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(finishedOuterRect, getStartingDegree(), getProgressAngle(), true, finishedPaint);
        canvas.drawArc(unfinishedOuterRect, getStartingDegree() + getProgressAngle(), 360 - getProgressAngle(), true, unfinishedPaint);

        if (SHOWprogress < 0)
            SHOWprogress = 0;
        String text = this.text != null ? this.text : prefixText + SHOWprogress + suffixText;
